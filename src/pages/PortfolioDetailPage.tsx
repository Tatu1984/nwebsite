...
import { ArrowLeft, CheckCircle, Zap, Target, Clock, Users, Quote, Activity, Stethoscope, Building2, Server } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="page-container portfolio-detail-page">
            ...
            <div className="portfolio-hero-grid">
              ...
              <div className="portfolio-hero-content">
                <div className="portfolio-hero-icon-wrapper">
                  <div className="portfolio-hero-icon" style={{ background: project.gradient }}>
                    {projectIcons[slug || ""] || <Activity size={48} />}
                  </div>
                </div>
                <span className="portfolio-hero-category">{details.category}</span>
                <h1 className="portfolio-hero-title">{details.title}</h1>
                <p className="portfolio-hero-subtitle">{details.subtitle}</p>
                <p className="portfolio-hero-desc">{details.heroDescription}</p>
        ...
        <section className="portfolio-detail-section alt">
          <div className="section-container">
            ...
            <div className="portfolio-mission-wrapper">
              ...
              <div className="portfolio-mission-points">
                {details.missionPoints.map((point, i) => (
                  <div key={i} className="portfolio-mission-item">
          ...
          <div className="section-container">
            ...
            <div className="portfolio-deliverables-grid">
              {details.deliverables.map((item, i) => (
                <div key={i} className="portfolio-deliverable-item">
        ...
        <section className="portfolio-detail-section alt">
          <div className="section-container">
            <h2 className="portfolio-section-title">Pain Points & Solutions</h2>
          ...
          <div className="section-container">
            ...
            <div className="portfolio-results-grid">
              {details.results.map((result, i) => (
                <div key={i} className="portfolio-result-item">
            ...
            <div className="section-container">
              <div className="portfolio-testimonial-card">
                ...
                <div className="testimonial-author">
                  <span className="testimonial-name">{details.testimonial.author}</span>
                  <span className="testimonial-role">{details.testimonial.role}</span>
                </div>
              </div>
            </div>
          </section>
